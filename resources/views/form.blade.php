...
<html lang="en">
      ...
      <form action="{{ route('generate-pdf') }}" method="POST">
        ...
        <div class="form-group form-group-box">
          <div class="box">
            ...
            <textarea id="images_title" name="images_title"></textarea>
            </div>
        </div>

        <div class="form-group form-group-box">
          <div class="box">
          <label for="images_desc">Description:</label>
          <textarea id="images_desc" name="images_desc"></textarea>
          </div>

          <div class="box">
            <label for="images_date">Date:</label>
            <input type="date" id="images_date" name="images_date" />
          </div>
        </div>

        <div class="form-group">
          <div class="file-input-container">
            <button class="file_input">Upload Images</button>
            <input type="file" id="upload_images" name="upload_images" accept=".png, .jpg, .jpeg, .gif, .pdf" multiple />
          </div>

          <!-- Preview Gantt Charts -->
          <div id="images-preview" style="display: none;">
            <h4>Images Previews:</h4>
      ...
      <form action="{{ route('test') }}" method="POST">
        ...
        <div class="form-group form-group-box">
            <div class="box">
                ...
                <select id="accomplishment_type" name="accomplishment_type" required>
        ...
        <div class="form-group form-group-box">
            ...
            <div class="box">
                <label for="acc_others">Others:</label>
                <input type="text" id="acc_others" name="acc_others" placeholder="Specify if any" />
            </div>
        </div>
  ...
  // Images Script
  document.addEventListener('DOMContentLoaded', function() {
      var uploadImages = document.getElementById('upload_images');
      var imagesPreviewContainer = document.getElementById('images-preview-container');
      var imagesPreview = document.getElementById('images-preview');

      if (uploadImages) {
          uploadImages.addEventListener('change', function(event) {
              const files = event.target.files;
              ...
              if (files.length > 0) {
                  ...
                  Array.from(files).forEach(file => {
                      ...
                      reader.onload = function(e) {
                          ...
                          imagesPreviewContainer.appendChild(previewElement);
                      };
                      reader.readAsDataURL(file);
                  });
              } else {
