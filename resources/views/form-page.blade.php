        ...
        <section id="pabout" class="about-wel-padding">
            <div class="auto-container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="welcome-section-title">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt utd labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco lab nisi ut aliquip ex ea commodo consequat. <br> Pellentesque Sed ut perspiciatis unde omnis iste nat error sitre voluptatem accusantium udema doloremque laudantium, totarmd aperiam.</p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                ...
                <div class="container-wrapper">
                  <a href="DPM-USTP-FIC-001.blade.php" class="container">Conduct of Externally Requested Consultation</a>
                  <a href="DPM-USTP-FIC-002.blade.php" class="container">Client Initiated Food Product Development</a>
                  <a href="DPM-USTP-FIC-003.blade.php" class="container">Researcher Initiated Food Product Development</a>
                  <a href="DPM-USTP-FIC-004.blade.php" class="container">Rental of Equipment</a>
                </div>
