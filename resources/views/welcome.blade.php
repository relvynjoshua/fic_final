...
<body id="main">
   ...
   <section class="slider-section">
      <div class="home-slides owl-carousel owl-theme">
         ...
         <!-- end single slider -->
         <div class="home-single-slide" data-background=" {{ asset('/img/bldg/logo_day2.jpg') }}">
            <div class="home-single-slide-overlay"></div>
            <div class="home-single-slide-inner">
               <div class="container">
                  <div class="row">
         ...
         <!-- end single slider -->
         <div class="home-single-slide" data-background="{{ asset('/img/bldg/logo_night.jpg') }}">
            <div class="home-single-slide-overlay"></div>
            <div class="home-single-slide-inner">
               <div class="container">
                  <div class="row">
         ...
         <div class="row">
            <div class="col-lg-6 col-md-6 col-12 mb-lg-0 mb-lg-0 mb-5">
               <div class="about-wel-des">
                  ...
                  <p class="my-4"><b>It is envisioned that through the Center, support technical expertise, relevant
                        science and technology (S&T) services, infrastructure and facility requirements, will be more
                        accessible for the micro-, small- and medium-scale enterprises (MSMEs) in the food industry at
                        the countryside.</b></p>
            ...
            <div class="col-lg-6 col-md-6 col-12">
               <div class="about-wel-img-sec img-overlay">
                  ...
                  <div class="img-wrap">
                     <img class="img-fluid" src="{{ asset('/img/bg/home-about-img.jpg') }}" alt="">
   ...
   <section id="counter" class="counter-padding overlay section-back-image"
      data-background="{{ asset('/img/bg/ustp3.png') }}">
      <div class="auto-container">
         <div class="row">
               ...
               <div class="team-slides owl-carousel owl-theme">
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('img/team/sevenseven.png') }}" alt="">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/bossamo.png') }}" alt="">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/threethree.png') }}" alt="">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/eighteight.png') }}" alt="">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/ninenine.png') }}" alt="">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/fivefive.png') }}" alt="">
                        <div class="single-team-member-content">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/twotwo.png') }}" alt="">
                        <div class="single-team-member-content">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/oneone.png') }}" alt="">
                        <div class="single-team-member-content">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/fourfour.png') }}" alt="">
                        <div class="single-team-member-content">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/sixsix.png') }}" alt="">
                        <div class="single-team-member-content">
                  ...
                  <div class="single-team-wrapper">
                     <div class="single-team-member">
                        <img class="img-fluid" src="{{ asset('/img/team/10.png') }}" alt="">
                        <div class="single-team-member-content">
   ...
   <section id="testimonial" class="section-padding overlay section-back-image"
      data-background=" {{ asset('/img/bg/ustp4.png') }}">
      <div class="auto-container">
         <div class="row ml-lg-4 ml-md-4 ml-0 mr-lg-4 mr-md-4 mr-0">
            <div class="col-lg-6 col-md-12 col-12 mb-lg-0 mb-md-5 mb-5">
               ...
               <div class="owl-carousel owl-theme testimonial-wrapper">
                  <div class="item"
                     data-dot="<img class='testimonial-thumb rounded' src={{ asset('/img/testimonial/person.jpg') }}/>">
                     <div class="testimonial-inner">
                        ...
                        <div class="tes-dec">
                           ...
                           <p class="author-des">Pellentesque Sed ut perspiciatis unde omnis iste natus error sitre
                              voluptatem accusantium udema doloremque laudantium, totarmd aperiam, eaque ipsa quae ab
                              illa inventore veritatis et quasi lorem architecto beatae vitae dicta sun explicabo.</p>
                  ...
                  <!-- end single item -->
                  <div class="item"
                     data-dot="<img class='testimonial-thumb rounded' src={{ asset('/img/testimonial/person2.jpg') }}/>">
                     <div class="testimonial-inner">
                        <div class="tes-quote">
                           <i class="icofont-quote-left"></i>
                        </div>
                  ...
                  <!-- end single item -->
                  <div class="item"
                     data-dot="<img class='testimonial-thumb rounded' src={{ asset('/img/testimonial/person3.jpg') }}/>">
                     <div class="testimonial-inner">
                        <div class="tes-quote">
                           <i class="icofont-quote-left"></i>
                        </div>
                     ...
                     <div class="panel-heading">
                        <h5 class="panel-title">
                           <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                              href="#panel1">Where is the NMFIC located? <i
                                 class=" text-white icofont icofont-minus"></i></a>
                        </h5>
                     </div>
                     <div id="panel1" class="panel-collapse collapse show">
                        <div class="panel-body text-white">
                           <p>Cras sit amet nibh libero, in gravida nulla. Nulla velmetus scelerisque ante sollicitudin.
                              Cras purus odio, vestibulum in vulputate.</p>
                        </div>
                     </div>
                  </div>
                  <div class="panel panel-default mb-3">
                     <div class="panel-heading">
                        <h5 class="panel-title">
                           <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                              href="#panel2">What services does the NMFIC provide? <i
               ...
               <figure class="portfolio-sin-item">
                  ...
                  <figcaption>
                     ...
                     <div class="port-icon mt-3">
                        <a class="icon-ho venobox" href="{{ asset('/img/NMFIC.jpg') }}"
                           data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-4 mb-4 four">
               <figure class="portfolio-sin-item">
                  ...
                  <figcaption>
                     ...
                     <div class="port-icon mt-3">
                        <a class="icon-ho venobox" href="{{ asset('/img/NMFIC1.jpg') }}"
                           data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                        <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                     </div>
                  </figcaption>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-4 mb-4 two four">
               <figure class="portfolio-sin-item">
                  ...
                  <figcaption>
                     ...
                     <div class="port-icon mt-3">
                        <a class="icon-ho venobox" href="{{ asset('/img/NMFIC2.jpg') }}"
                           data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                        <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                     </div>
                  </figcaption>
            ...
            <div class="col-lg-4 col-md-6 col-12 two mb-md-4 mb-4 one three">
               <figure class="portfolio-sin-item">
                  ...
                  <figcaption>
                     ...
                     <div class="port-icon mt-3">
                        <a class="icon-ho venobox" href="{{ asset('/img/NMFIC3.jpg') }}"
                           data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                        <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                     </div>
                  </figcaption>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4 two one">
               <figure class="portfolio-sin-item">
                  ...
                  <figcaption>
                     <h3>Food Production</h3>
                     <div class="port-icon mt-3">
                        <a class="icon-ho venobox" href="{{ asset('/img/NMFIC4.jpg') }}"
                           data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                        <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                     </div>
                  </figcaption>
            ...
            <div class="col-lg-4 col-md-6 col-12 one three four">
               <figure class="portfolio-sin-item">
                  ...
                  <figcaption>
                     <h3>NMFIC Booth</h3>
                     <div class="port-icon mt-3">
                        <a class="icon-ho venobox" href="{{ asset('/img/NMFIC5.jpg') }}"
                           data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                        <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                     </div>
                  </figcaption>
               ...
               <div class="blog-slides owl-carousel owl-theme">
                  <div class="blog-home-single">
                     <div class="blog-home-image">
                        <img class="img-fluid" src="{{ asset('/img/blog/FIC.jpg') }}" alt="" />
                     ...
                     <div class="blog-home-des-wrap">
                        ...
                        <div class="blog-home-des-right">
                           <div class="havator">
                              <img class="img-fluid" src="{{ asset('/img/testimonial/person.jpg') }}" alt="" />
                           </div>
                  ...
                  <div class="blog-home-single">
                     <div class="blog-home-image">
                        <img class="img-fluid" src="{{ asset('/img/blog/FIC2.jpg') }}" alt="" />
                        <div class="blog-home-post-date">
                           <i class="icofont-clock-time"></i>
                     ...
                     <div class="blog-home-des-wrap">
                        ...
                        <div class="blog-home-des-right">
                           <div class="havator">
                              <img class="img-fluid" src="{{ asset('/img/testimonial/person2.jpg') }}" alt="" />
                           </div>
                           <div class="blog-home-meta">
                              <span>Post By<a href="#">USTP - FIC</a></span>
                  ...
                  <div class="blog-home-single">
                     <div class="blog-home-image">
                        <img class="img-fluid" src="{{ asset('/img/blog/FIC3.jpg') }}" alt="" />
                        <div class="blog-home-post-date">
                           <i class="icofont-clock-time"></i>
                     ...
                     <div class="blog-home-des-wrap">
                        ...
                        <div class="blog-home-des-right">
                           <div class="havator">
                              <img class="img-fluid" src="{{ asset('/img/testimonial/person3.jpg') }}" alt="" />
                           </div>
                           <div class="blog-home-meta">
                              <span>Post By<a href="#">USTP - FIC</a></span>
                              <span>Service, Progress</span>
                  ...
                  <div class="blog-home-single">
                     <div class="blog-home-image">
                        <img class="img-fluid" src="{{ asset('/img/blog/FIC4.jpg') }}" alt="" />
                        <div class="blog-home-post-date">
                           <i class="icofont-clock-time"></i>
                     ...
                     <div class="blog-home-des-wrap">
                        ...
                        <div class="blog-home-des-right">
                           <div class="havator">
                              <img class="img-fluid" src="{{ asset('/img/testimonial/person4.jpg') }}" alt="" />
                           </div>
                           <div class="blog-home-meta">
                              <span>Post By<a href="#">USTP - FIC</a></span>
