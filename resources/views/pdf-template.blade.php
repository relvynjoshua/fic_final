...
<div class="container">
    ...
    <div class="form-group">
        ...
        <span class="value">{{ $activity_date }}</span>
    </div>
    ...
    <table>
        ...
        <tr>
            <td><span class="value">{{ $images_title }}</span></td>
            <td><span class="value">{{ $images_date }}</span></td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            <td><span class="value">{{ $images_desc }}</span></td>
            <td><span class="value">{{ $upload_images }}</span></td>
        </tr>
    </table>
</div>
</body>
