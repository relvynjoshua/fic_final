...
<head>
    ...
    <!-- Page Title -->
    <title>Researcher Initiated Food Product Development</title>
...
<body>
    <div id="main">
        <div class="header">
            ...
            <div class="document-code">DPM-USTP-FIC-003</div>
            <h1>Researcher Initiated Food Product Development</h1>
        </div>
        ...
        <div class="container1-wrapper">
            <div class="container1">
                ...
                <ol>
                    <li>Request of rental for equipment or NMFIC facility</li>
                    <li>Checking of NMFIC schedule.</li>
                    <li>Completion and approval of the request.</li>
                    <li>Execution of food processing or packaging service requested.</li>
                    <li>Issuance of billing statement.</li>
                    <li>Payment of applicable fees.</li>
                    <li>Release of processed / packed product.</li>
                </ol>
            </div>
            ...
            <div class="container1">
                ...
                <ul>
                    <li><a href="FM-USTP-FIC-001.blade.php">Food Product Development Request Form (FM-USTP-FIC-001)</a></li>
                </ul>
