               ...
               <div class="address-box-wrap bg-gray shadow-sm p-lg-5 p-md-3 p-3">
                  <div class="address-box-sin mb-4">
                     ...
                     <div class="address-box-des">
                        ...
                        <p>Claro M. Recto Ave, Cagayan de Oro, <br> 9000 Misamis Oriental</p>
                     </div>
                  </div>
                  ...
                  <div class="address-box-sin mb-4">
                     ...
                     <div class="address-box-des">
                        <h4>Send Email</h4>
                        <p>nmfic@ustp.edu.ph <br> fic.com</p>
                     </div>
                  </div>
                  <!-- end single address box -->
                  <div class="address-box-sin mb-4">
                     ...
                     <div class="address-box-des">
                        <h4>Phone & Fax</h4>
                        <p>+6396678133 <br> 856 8159 (local 1193)</p>
                     </div>
                  </div>
                  <!-- end single address box -->
                  <div class="address-box-sin">
                     ...
                     <div class="address-box-des">
                        <h4>Opening Time</h4>
                        <p>Mon - Fri: 8 AM - 5 PM <br> Sun: Close</p>
                     </div>
                  </div>
                  <!-- end single address box -->
               </div>
               ...
               <div class="contact-form-wrap">
                  <form id="main-form" class="contact-form form" name="enq" method="POST" action="form-process.php">
                     ...
                     <div class="text-center wow fadeInUp">
                        <div class="actions">
                           <input value="SUBMIT MESSAGE" name="submit" id="submitButton" class="btn con-btn"
                              title="Click here to submit your message!" type="submit">
                           <img src="{{asset('img/ajax-loader.gif') }}" id="loader" style="display:none" alt="loading"
                              width="16" height="16">
                        </div>
                     </div>
                  </form>
   ...
   <div class="section-padding py-0">
      ...
      <div class="gmap_canvas">
         <iframe id="gmap_canvas"
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15784.902401009245!2d124.6766477!3d8.4774312!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32fff3efcbef9025%3A0xc8756bf5087e18aa!2sCollege%20Of%20Technology%20USTP!5e0!3m2!1sen!2sph!4v1712330633720!5m2!1sen!2sph"></iframe>
      </div>
      <!-- end google map -->
   </div>
   <!-- END MAP SECTION -->
