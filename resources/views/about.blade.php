...
<html lang="en">
   ...
   <body>
                     ...
                     <div class="col-lg-9 d-none d-lg-block d-md-none">
                        <nav class="navbar navbar-expand-lg justify-content-left">
                           <ul class="navbar-nav">
                              ...
                              <li class="active" ><a href="about.blade.php" class="nav-link">About Us</a></li>
      ...
      <!-- START PAGEBREDCUMS -->
      <div class="page-banner page-banner-overlay" data-background="assets/img/bldg/bldg1_night.jpg">
         ...
         <div class="auto-container">
            <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-lg-0 mb-lg-0 mb-5">
                  <img class="img-fluid" src="assets/img/bldg/bldg2.JPG" alt=""/>
               </div>
               <!-- end col -->
      ...
      <section id="counter" class="counter-section counter-padding overlay section-back-image" data-background="assets/img/bldg/bldg2.jpg">
         <div class="auto-container">
            ...
            <div class="row">
               <div class="col-lg-7 col-md-7 col-12 mx-auto text-center">
                  <div class="section-title">
                     ...
                     <p>The Northern Mindanao Food Innovation Center (NMFIC) serves as a Technology Hub for Innovations, R&D, and Support Services for the food industry in Northern Mindanao. The NMFIC helps create efficient technology development and transfer and facilitates the commercialization of technologies for sustainable local economic growth and productivity. The NMFIC provides the following services: Technology Hub, Technical Consultancy and Advisory, Testing Laboratory, and Complementary Food Production.</p>
                  </div>
               </div>
            </div>
            <!-- end section title -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12 mb-lg-0 mb-md-0 mb-5 text-lg-right text-left">
                                       <div class="service-tab-left">
                                          ...
                                          <p>Pentesque Sed ut perspiciatis unde omnis iste natus aque errors set voluptatem accusantium udema dolor emqueler error laudantium, totarmd aperiam, eaque ipsa quae ab illa inventore veritatis et quasi lorem architecto beatae vitae.</p>
                                       </div>
                                    </div>
                                    <!-- end col -->
         ...
         <div class="auto-container">
            ...
            <div class="row">
               <div class="col-lg-6 col-md-6 col-12 mb-lg-0 mb-md-0 mb-4 wow fadeInLeft">
                  <div class="testimonial-style-2">
                     <div class="testimonial-style-2-left">
                        <img class="testimonial-thumb rounded-circle" src="assets/img/testimonial/maloi.jpg" alt="">
                        <h4>Maloi</h4>
                        <span>Doctor</span>
                     </div>
                     <div class="testimonial-style-2-right rounded">
                        <p>Pellentesque Sed ut perspiciatis unde omnis iste natus error sitre voluptatem accusantium udema doloremque laudantium, totarmd aperiam, eaque ipsa quae ab illa inventore veritati.</p>
                     </div>
                  </div>
               </div>
               <!-- end col -->
               <div class="col-lg-6 col-md-6 col-12 wow fadeInRight">
                  <div class="testimonial-style-2">
                     <div class="testimonial-style-2-left">
                        <img class="testimonial-thumb rounded-circle" src="assets/img/testimonial/maki.png" alt="">
                        <h4>Maki</h4>
                        <span>Lawyer</span>
                     </div>
                     <div class="testimonial-style-2-right rounded">
