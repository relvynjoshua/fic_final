            ...
            <div class="auto-container">
               <div class="row">
                  ...
                  <div class="col-lg-8 col-md-12 col-sm-12 col-12 text-lg-right text-center">
                     <div class="top-menu">
                        <ul>
                           <li><a href="#"><i class="icofont-location-pin"></i>Claro M. Recto Ave, Cagayan de Oro, 9000 Misamis Oriental</a></li>
                           ...
                           <ul class="navbar-nav">
                              ...
                              <li class="dropdown"><a class="nav-link" href="services.blade.php">Services</a>
                                 <ul class="dropdown-menu">
                                    <li><a href="single-service.blade.php">DOCUMENTS</a></li>
                                    <li><a href="single-service.blade.php">FORMS</a></li>
                              ...
                              <li class="active"><a class="nav-link" href="news.blade.php">NEWS</a>
                                </ul>
                              </li>
                     ...
                     <div class="single-blog-post-content">
                        ...
                        <div class="single-blog-post-video">                        
                           <div class="embed-responsive embed-responsive-16by9">
                              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Oq61TxejZ5g"></iframe>
                           </div>                           
                        </div>
                        <p>
                           Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia.
                     ...
                     <div class="sidebar-widget-inner">
                        ...
                        <form class="search-box">
                          <div class="search-body row no-gutters align-items-center">
                              <div class="col">
                                  <input class="form-control form-control-lg search-box-form-control" type="search" placeholder="Search...">
                              </div>
                              <!--end of col-->
                              <div class="col-auto">
                                  <button class="btn btn-lg btn-search" type="submit"><i class="icofont-search-2"></i></button>
                              </div>
                              <!--end of col-->
                          </div>
                        </form>
            ...
            <div class="auto-container">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-0 mb-sm-5 mb-5">
                     ...
                     <div class="footer-widget-inner">
                        <ul>
                           <li><a href="#"><i class="icofont-circled-right"></i> Documents</a></li>
                           <li><a href="#"><i class="icofont-circled-right"></i> Latest Services</a></li>
                           <li><a href="#"><i class="icofont-circled-right"></i> Administration</a></li>
